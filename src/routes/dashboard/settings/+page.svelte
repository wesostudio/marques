<script>
  import DashboardMainNav from "$lib/components/dashboard/main-nav.svelte";
  import Search from "$lib/components/dashboard/search.svelte";
  import TeamSwitcher from "$lib/components/dashboard/team-switcher.svelte";
...
<div class="hidden flex-col md:flex">
  ...
  <main class="container p-8">
    <h1 class="text-4xl font-semibold">Configuracion</h1>
