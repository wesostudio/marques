...
<div class="hidden flex-col md:flex">
  ...
  <div class="flex-1 space-y-4 p-8 pt-6">
    ...
    <Tabs.Root value="overview" class="space-y-4">
      <Tabs.List>
        <Tabs.Trigger value="overview">Estadisticas</Tabs.Trigger>
        <Tabs.Trigger value="stock">Stock</Tabs.Trigger>
        <Tabs.Trigger value="reports">Reportes</Tabs.Trigger>
        <Tabs.Trigger value="providers">Proveedores</Tabs.Trigger>
      </Tabs.List>
      ...
      <Tabs.Content value="stock" class="space-y-4">Stock</Tabs.Content>
      <Tabs.Content value="reports" class="space-y-4">Reportes</Tabs.Content>
      <Tabs.Content value="providers" class="space-y-4"
        >Proveedores</Tabs.Content
      >
    </Tabs.Root>
  </div>
</div>
